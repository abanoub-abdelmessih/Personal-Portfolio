...
export function ExperienceItem({
  ...
  return (
    <div className="space-y-4 first:pt-0 py-4">
      <div className="not-prose flex items-center gap-3">
        ...
        <h3 className="text-base md:text-lg leading-snug font-medium flex items-center gap-2 flex-wrap">
  ...
  return (
    <Collapsible defaultOpen={position.isExpanded} asChild>
      <div className="relative last:before:absolute last:before:h-full last:before:w-4 last:before:bg-background">
        <CollapsibleTrigger
          className={cn(
            "group/experience not-prose block w-full text-left select-none cursor-pointer",
            "relative before:absolute before:-top-1 before:-right-1 before:-bottom-1.5 before:left-7 before:rounded-lg hover:before:bg-muted/50 py-1"
          )}
        >
